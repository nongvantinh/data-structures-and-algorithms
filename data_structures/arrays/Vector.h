...
typename dsaa::array::Vector<Elem, Alloc>::iterator dsaa::array::Vector<Elem, Alloc>::begin() noexcept
{
	return m_elements ? iterator(&m_elements[0]) : iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_iterator dsaa::array::Vector<Elem, Alloc>::begin() const noexcept
{
	return m_elements ? const_iterator(&m_elements[0]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::iterator dsaa::array::Vector<Elem, Alloc>::end() noexcept
{
	return m_elements ? iterator(&m_elements[size()]) : iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_iterator dsaa::array::Vector<Elem, Alloc>::end() const noexcept
{
	return m_elements ? const_iterator(&m_elements[size()]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reverse_iterator dsaa::array::Vector<Elem, Alloc>::rbegin() noexcept
{
	return reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reverse_iterator dsaa::array::Vector<Elem, Alloc>::rbegin() const noexcept
{
	return const_reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reverse_iterator dsaa::array::Vector<Elem, Alloc>::rend() noexcept
{
	return reverse_iterator(begin());
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reverse_iterator dsaa::array::Vector<Elem, Alloc>::rend() const noexcept
{
	return const_reverse_iterator(begin());
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_iterator dsaa::array::Vector<Elem, Alloc>::cbegin() const noexcept
{
	return m_elements ? const_iterator(&m_elements[0]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_iterator dsaa::array::Vector<Elem, Alloc>::cend() const noexcept
{
	return m_elements ? const_iterator(&m_elements[size()]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reverse_iterator dsaa::array::Vector<Elem, Alloc>::crbegin() const noexcept
{
	return const_reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reverse_iterator dsaa::array::Vector<Elem, Alloc>::crend() const noexcept
{
	return const_reverse_iterator(begin());
}
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reference dsaa::array::Vector<Elem, Alloc>::operator[](size_type p_index)
{
	return m_elements[p_index];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reference dsaa::array::Vector<Elem, Alloc>::operator[](size_type p_index) const
{
	return m_elements[p_index];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reference dsaa::array::Vector<Elem, Alloc>::at(const size_type &p_index)
{
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reference dsaa::array::Vector<Elem, Alloc>::at(const size_type &p_index) const
{
	if (p_index < 0 || size() <= p_index)
		throw std::out_of_range("p_index out of range exception.\n");
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reference dsaa::array::Vector<Elem, Alloc>::front()
{
	return m_elements[0];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reference dsaa::array::Vector<Elem, Alloc>::front() const
{
	return m_elements[0];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::reference dsaa::array::Vector<Elem, Alloc>::back()
{
	return m_elements[size() - 1];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_reference dsaa::array::Vector<Elem, Alloc>::back() const
{
	return m_elements[size() - 1];
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::pointer dsaa::array::Vector<Elem, Alloc>::data() noexcept
{
	return m_elements;
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::const_pointer dsaa::array::Vector<Elem, Alloc>::data() const noexcept
{
	return m_elements;
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::allocator_type dsaa::array::Vector<Elem, Alloc>::get_allocator() const noexcept
{
	return m_allocator;
}
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::size_type dsaa::array::Vector<Elem, Alloc>::capacity() const noexcept
{
	return m_capacity;
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::size_type dsaa::array::Vector<Elem, Alloc>::size() const noexcept
{
	return m_size;
}

template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::size_type dsaa::array::Vector<Elem, Alloc>::max_size() const noexcept
{
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::iterator dsaa::array::Vector<Elem, Alloc>::insert(const_iterator p_position, const_reference p_value)
{
...
template <typename Elem, typename Alloc>
typename dsaa::array::Vector<Elem, Alloc>::iterator dsaa::array::Vector<Elem, Alloc>::erase(const_iterator p_position)
{
	if (p_position == end())
		return p_position;
