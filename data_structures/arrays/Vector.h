...
typename dsaa::Vector<Elem, Alloc>::iterator dsaa::Vector<Elem, Alloc>::begin() noexcept
{
	return m_elements ? iterator(&m_elements[0]) : iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_iterator dsaa::Vector<Elem, Alloc>::begin() const noexcept
{
	return m_elements ? const_iterator(&m_elements[0]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::iterator dsaa::Vector<Elem, Alloc>::end() noexcept
{
	return m_elements ? iterator(&m_elements[size()]) : iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_iterator dsaa::Vector<Elem, Alloc>::end() const noexcept
{
	return m_elements ? const_iterator(&m_elements[size()]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reverse_iterator dsaa::Vector<Elem, Alloc>::rbegin() noexcept
{
	return reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reverse_iterator dsaa::Vector<Elem, Alloc>::rbegin() const noexcept
{
	return const_reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reverse_iterator dsaa::Vector<Elem, Alloc>::rend() noexcept
{
	return reverse_iterator(begin());
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reverse_iterator dsaa::Vector<Elem, Alloc>::rend() const noexcept
{
	return const_reverse_iterator(begin());
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_iterator dsaa::Vector<Elem, Alloc>::cbegin() const noexcept
{
	return m_elements ? const_iterator(&m_elements[0]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_iterator dsaa::Vector<Elem, Alloc>::cend() const noexcept
{
	return m_elements ? const_iterator(&m_elements[size()]) : const_iterator(nullptr);
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reverse_iterator dsaa::Vector<Elem, Alloc>::crbegin() const noexcept
{
	return const_reverse_iterator(end());
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reverse_iterator dsaa::Vector<Elem, Alloc>::crend() const noexcept
{
	return const_reverse_iterator(begin());
}

template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(const allocator_type &p_allocator)
	: m_allocator{p_allocator}, m_capacity{0}, m_size{0}, m_elements{nullptr} {}

template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(const size_type &p_size, const allocator_type &p_allocator)
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(const size_type &p_size, const_reference p_value, const allocator_type &p_allocator)
	: m_allocator{p_allocator}, m_capacity{p_size}, m_size{p_size}, m_elements{nullptr}
{
	m_elements = std::allocator_traits<allocator_type>::allocate(m_allocator, capacity());
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(const Vector &p_other)
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(const Vector &p_other, const allocator_type &p_allocator)
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(Vector &&p_other)
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(Vector &&p_other, const allocator_type &p_allocator)
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc> &dsaa::Vector<Elem, Alloc>::operator=(const Vector &p_other)
{
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc> &dsaa::Vector<Elem, Alloc>::operator=(Vector &&p_other)
{
	for (iterator i{begin()}; i != end(); ++i)
		std::allocator_traits<allocator_type>::destroy(m_allocator, i);
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc> &dsaa::Vector<Elem, Alloc>::operator=(std::initializer_list<value_type> p_elements)
{
	// Quarantees elements are copies and no error happens before delete old elements.
...
template <typename Elem, typename Alloc>
dsaa::Vector<Elem, Alloc>::Vector(std::initializer_list<value_type> p_list, const allocator_type &p_allocator)
...
template <typename Elem, typename Alloc>
template <typename IIterator>
dsaa::Vector<Elem, Alloc>::Vector(IIterator p_first, IIterator p_last, const allocator_type &p_allocator)
	: m_allocator{p_allocator}, m_capacity{0}, m_size{0}, m_elements{nullptr}
{
	resize(10);
...
template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reference dsaa::Vector<Elem, Alloc>::operator[](size_type p_index)
{
	return m_elements[p_index];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reference dsaa::Vector<Elem, Alloc>::operator[](size_type p_index) const
{
	return m_elements[p_index];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reference dsaa::Vector<Elem, Alloc>::at(const size_type &p_index)
{
...
template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reference dsaa::Vector<Elem, Alloc>::at(const size_type &p_index) const
{
	if (p_index < 0 || size() <= p_index)
		throw std::out_of_range("p_index out of range exception.\n");
...
template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reference dsaa::Vector<Elem, Alloc>::front()
{
	return m_elements[0];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reference dsaa::Vector<Elem, Alloc>::front() const
{
	return m_elements[0];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::reference dsaa::Vector<Elem, Alloc>::back()
{
	return m_elements[size() - 1];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_reference dsaa::Vector<Elem, Alloc>::back() const
{
	return m_elements[size() - 1];
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::pointer dsaa::Vector<Elem, Alloc>::data() noexcept
{
	return m_elements;
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::const_pointer dsaa::Vector<Elem, Alloc>::data() const noexcept
{
	return m_elements;
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::allocator_type dsaa::Vector<Elem, Alloc>::get_allocator() const noexcept
{
	return m_allocator;
}

template <typename Elem, typename Alloc>
bool dsaa::Vector<Elem, Alloc>::empty() const noexcept
{
	return begin() == end();
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::size_type dsaa::Vector<Elem, Alloc>::capacity() const noexcept
{
	return m_capacity;
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::size_type dsaa::Vector<Elem, Alloc>::size() const noexcept
{
	return m_size;
}

template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::size_type dsaa::Vector<Elem, Alloc>::max_size() const noexcept
{
	return std::numeric_limits<value_type>::max() / sizeof(value_type);
}

template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::resize(const size_type &p_size, const value_type &p_value)
{
	reserve(p_size);
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::reserve(const size_type &p_capacity)
{
...
// Requests the container to reduce its capacity to fit its size.
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::shrink_to_fit()
{
	if (size() == capacity())
		return;
	// Allocate new space.
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::push_back(const_reference p_value)
{
	if (size() == capacity())
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::push_back(value_type &&p_value)
{
	if (size() == capacity())
		reserve(size() == 0 ? 8 : 2 * size()); // Make sure we have enough space.
	*end() = p_value;
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::pop_back()
{
...
template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::iterator dsaa::Vector<Elem, Alloc>::insert(const_iterator p_position, const_reference p_value)
{
...
template <typename Elem, typename Alloc>
typename dsaa::Vector<Elem, Alloc>::iterator dsaa::Vector<Elem, Alloc>::erase(const_iterator p_position)
{
	if (p_position == end())
		return p_position;
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::clear() noexcept
{
...
template <typename Elem, typename Alloc>
template <typename BIterator>
void dsaa::Vector<Elem, Alloc>::assign(BIterator p_first, BIterator p_last)
{
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::assign(size_type p_size, const value_type &p_value)
{
	// Allocate new space.
...
template <typename Elem, typename Alloc>
void dsaa::Vector<Elem, Alloc>::assign(std::initializer_list<value_type> p_list)
{
